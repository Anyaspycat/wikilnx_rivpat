...
| 15 | ChatGPT | Revisión visual de componentes | Se solicita corregir problemas puntuales de visualización sin cambiar el contenido: imágenes pequeñas, textos desordenados, pestañas descentradas, pasos que no cierran y tablas poco legibles. | Se propusieron correcciones específicas sobre los componentes y estilos existentes. Los cambios fueron probados y aplicados de forma progresiva. |
| 16 | ChatGPT | `07_prompts_rivpat.md` | Necesito ajustar la redacción de lo incluido en `07_prompts_rivpat.md` para mostrar la bitácora de IA con los prompts utilizados. | Se ajustó la estructura para representar la bitácora dentro de la wiki |
